...
export const LEVELS: LevelConfig[] = [
  ...
  { id: 14, type: 'collect', goal: { type: 'collect', target: 35, element: 'dog' }, moves: 20, obstacles: [{ type: 'wood', positions: [{ row: 2, col: 2 }, { row: 2, col: 3 }, { row: 2, col: 4 }, { row: 2, col: 5 }, { row: 3, col: 2 }, { row: 3, col: 5 }, { row: 4, col: 2 }, { row: 4, col: 5 }, { row: 5, col: 2 }, { row: 5, col: 3 }, { row: 5, col: 4 }, { row: 5, col: 5 }] }] },
  ...
  // 16-20: 极限难度
  { id: 16, type: 'collect', goal: { type: 'collect', target: 35, element: 'tiger' }, moves: 23, obstacles: [{ type: 'wood', positions: [{ row: 1, col: 1 }, { row: 1, col: 2 }, { row: 1, col: 5 }, { row: 1, col: 6 }, { row: 6, col: 1 }, { row: 6, col: 2 }, { row: 6, col: 5 }, { row: 6, col: 6 }] }, { type: 'ice', positions: [{ row: 3, col: 3 }, { row: 3, col: 4 }, { row: 4, col: 3 }, { row: 4, col: 4 }] }] },
  ...
  { id: 20, type: 'clear', goal: { type: 'clear', target: 6 }, moves: 28, obstacles: [{ type: 'wood', positions: [{ row: 1, col: 1 }, { row: 1, col: 6 }, { row: 6, col: 1 }, { row: 6, col: 6 }] }, { type: 'ice', positions: [{ row: 2, col: 2 }, { row: 2, col: 5 }, { row: 5, col: 2 }, { row: 5, col: 5 }, { row: 3, col: 3 }, { row: 3, col: 4 }, { row: 4, col: 3 }, { row: 4, col: 4 }] }] },
];
